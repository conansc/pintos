...
dir_remove (struct dir *dir, const char *name)
{
  ...
  if (inode_is_directory(inode) && !dir_empty(inode))
    goto done;
...
/* Gets and opens the parent of a given directory. Sets
   given inode pointer to parent. */
bool dir_parent(struct dir *dir, struct inode **inode)
{
  block_sector_t s = inode_get_parent(dir_get_inode(dir));
  *inode = inode_open(s);
  return *inode != NULL;
}
...
/* Checks if directory of given inode is empty */ 
